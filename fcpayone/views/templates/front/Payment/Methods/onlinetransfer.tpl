...
<div class="box js-payone-validate" data-payone-validation-url="{$sFcPayoneValidationUrl|escape:'html':'UTF-8'}" data-payone-payment-id="{$oFcPayonePayment->getId()|escape:'html':'UTF-8'}">
    <fieldset>
        ...
        <div class="form-group required">
            <label for="ottype" class="control-label col-lg-4">{$oFcPayoneTranslator->translate('FC_PAYONE_FRONTEND_ONLINETRANSFER_TYPE')|escape:'html':'UTF-8'} <sup>*</sup></label>
            <div class="col-lg-5">
        ...
        <div class="form-group required js-payment-bankgroup" data-payment-id="{$oSubPayment->getId()|escape:'html':'UTF-8'}">
            <label for="bankgrouptype" class="control-label col-lg-4">{$oFcPayoneTranslator->translate('FC_PAYONE_FRONTEND_ONLINETRANSFER_BANK_GROUP')|escape:'html':'UTF-8'} <sup>*</sup></label>
            <div class="col-lg-5">
                <select id="bankgrouptype" name="fcpayone_form[bankgrouptype_{$oSubPayment->getId()|escape:'html':'UTF-8'}]" class="form-control">
        ...
        <div class="js-payment-ibanbic">
            <div class="form-group required">
                <label for="iban" class="control-label col-lg-4">{$oFcPayoneTranslator->translate('FC_PAYONE_FRONTEND_IBAN')|escape:'html':'UTF-8'} <sup>*</sup></label>
                <div class="col-lg-5">
            ...
            <div class="form-group required">
                <label for="bic" class="control-label col-lg-4">{$oFcPayoneTranslator->translate('FC_PAYONE_FRONTEND_BIC')|escape:'html':'UTF-8'} <sup>*</sup></label>
                <div class="col-lg-5">
