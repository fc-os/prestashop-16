...
<div class="box">
    <fieldset>
        ...
        <div class="form-group required">
            <label for="cardtype" class="control-label col-lg-4">{$oFcPayoneTranslator->translate('FC_PAYONE_FRONTEND_CREDITCARD_TYPE')}
                <sup>*</sup></label>
            <div class="col-lg-5">
                <select id="cardtype" class="form-control">
                    {foreach from=$aFcPayoneSubPayments item=oSubPayment}
                        <option value="{$oSubPayment->getSubClearingType()}"
                                data-payone-subpayment-id="{$oSubPayment->getId()}">{$oSubPayment->getTitle()}</option>
                    {/foreach}
                </select>
        ...
        <div class="form-group required">
            <label for="cardpanInput"
                   class="control-label col-lg-4">{$oFcPayoneTranslator->translate('FC_PAYONE_FRONTEND_CREDITCARD_PAN')}
                <sup>*</sup></label>
        ...
        {if isset($blFcPayoneShowCvC) && $blFcPayoneShowCvC}
            <div class="form-group required">
                <label for="cvcInput"
                       class="control-label col-lg-4">{$oFcPayoneTranslator->translate('FC_PAYONE_FRONTEND_CREDITCARD_CVC')}
                    <sup>*</sup></label>
        ...
        <div class="form-group required">
            <label for="expireInput"
                   class="control-label col-lg-4">{$oFcPayoneTranslator->translate('FC_PAYONE_FRONTEND_CREDITCARD_EXPIRE')}
                <sup>*</sup></label>
        ...
        <div class="form-group required">
            <label for="firstname"
                   class="control-label col-lg-4">{$oFcPayoneTranslator->translate('FC_PAYONE_FRONTEND_CREDITCARD_FIRSTNAME')}
                <sup>*</sup></label>
            <div class="col-lg-5">
        ...
        <div class="form-group required">
            <label for="lastname"
                   class="control-label col-lg-4">{$oFcPayoneTranslator->translate('FC_PAYONE_FRONTEND_CREDITCARD_LASTNAME')}
                <sup>*</sup></label>
...
<span style="display:none;" class="js-payone-request-config"
      data-request-lang="{$sFcPayoneRequestLang}"
      data-request="{$sFcPayoneJsRequestData}"
      data-validation-expiredate-error="{$oFcPayoneTranslator->translate('FC_PAYONE_ERROR_CREDITCARD_EXPIRE_INVALID')}"
      data-validation-fields-error="{$oFcPayoneTranslator->translate('FC_PAYONE_ERROR_FILL_FIELDS')}">
</span>